...
export default function InstituteForm(){
  ...
  return (<AppLayout>
    <PageHeader title={editing?'Edit Institute':'New Institute'} />
    <form className="grid gap-4 max-w-xl bg-white p-6 rounded-xl shadow">
      ...
      <input className="border rounded px-3 py-2" placeholder="Country ID" />
      <input className="border rounded px-3 py-2" placeholder="City ID" />
      <input className="border rounded px-3 py-2" placeholder="Organization ID" />
